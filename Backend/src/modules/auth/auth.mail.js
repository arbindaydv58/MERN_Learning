  ...
  notifyUserActivationSuccess = async (user) => {
    try {
      ...
      const emailTemplate = `
        <div style="margin:0;padding:0;background-color:#031b12;">
          <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;">
            Your account is active. Login now and start using your ecommerce dashboard.
          </div>
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="width:100%;border-collapse:collapse;background:linear-gradient(180deg,#031b12 0%,#052e1f 100%);margin:0;padding:24px 0;">
            <tr>
              <td align="center">
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="680" style="width:680px;max-width:680px;border-collapse:collapse;background-color:#07281d;border:1px solid #0f5132;border-radius:18px;overflow:hidden;font-family:Arial,Helvetica,sans-serif;color:#d1fae5;box-shadow:0 18px 40px rgba(0,0,0,0.35);">
                  <tr>
                    <td style="padding:32px 40px 18px 40px;background:linear-gradient(135deg,#064e3b 0%,#022c22 55%,#021a13 100%);">
                      ...
                      <h1 style="margin:18px 0 12px 0;font-size:32px;line-height:40px;font-weight:700;color:#ecfdf5;">
                        Welcome to your ecommerce workspace
                      </h1>
                      <p style="margin:0;font-size:16px;line-height:26px;color:#a7f3d0;">
                        Your account is now active and ready for shopping, selling, and order management.
                      </p>
                    </td>
                  </tr>
                  <tr>
                    <td style="padding:34px 40px 16px 40px;background-color:#07281d;">
                      ...
                      <p style="margin:0 0 14px 0;font-size:15px;line-height:26px;color:#bbf7d0;">
                        Congratulations and welcome. Your profile has been successfully activated, and you can now access your full ecommerce dashboard to manage products, discover offers, and complete secure transactions in one place.
                      </p>
                      <p style="margin:0 0 14px 0;font-size:15px;line-height:26px;color:#bbf7d0;">
                        After login, start by completing your profile details, setting your delivery and billing preferences, and exploring categories to build a smarter shopping flow. If you are a seller, you can also organize listings, update inventory, and keep pricing aligned with your business goals.
                      </p>
                      <p style="margin:0 0 28px 0;font-size:15px;line-height:26px;color:#bbf7d0;">
                        Use the Orders and Activity sections regularly to track purchases, monitor fulfillment status, and review account activity. This helps you stay in control of every transaction while making the most of the platform experience.
                      </p>
                      <a href="${loginLink}" style="display:inline-block;padding:14px 26px;background-color:#10b981;color:#032117;text-decoration:none;font-size:15px;font-weight:700;border-radius:10px;border:1px solid #34d399;">
      ...
      return await this.svc.sendEmail({
        to: user.email,
        sub: "Welcome to our RN E-commerce platform!!",
        message: emailTemplate,
      });
    } catch (exception) {
      throw exception;
